...
WebUI.verifyNotEqual(result, 'form-label invalid')

WebUI.verifyElementNotPresent(findTestObject('ProfitFarmers_OR/UserAcc_01/Page_Sign Up/ul_Trading can bring big profits but also l_36bc11'), 
    0)

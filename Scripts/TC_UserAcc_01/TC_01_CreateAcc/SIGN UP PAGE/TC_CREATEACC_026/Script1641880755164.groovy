...
WebUI.verifyElementAttributeValue(findTestObject('ProfitFarmers_OR/UserAcc_01/Page_Sign Up/label_I agree to the Terms of Use and Privacy Policy'), 
    'class', 'form-label registration-checkbox invalid', 0)
